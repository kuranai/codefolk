...
function syntax(p: Palette): TextMateRule[] {
  ...
  return [
    ...
    { name: "Storage types", scope: "storage.type", settings: { foreground: s.storage } },
    ...
    { name: "Parameters", scope: "variable.parameter", settings: { foreground: s.parameter, fontStyle: "italic" } },
    ...
    { name: "Language variables", scope: ["variable.language", "variable.language.this", "variable.language.super"], settings: { foreground: s.languageVariable, fontStyle: "italic" } },
    ...
    { name: "Elixir keyword keys", scope: "constant.other.keywords.elixir", settings: { foreground: s.property } },
...
function semantics(p: Palette): Record<string, SemanticStyle> {
  ...
  return {
    ...
    "parameter": { foreground: s.parameter, italic: true },
    "property": s.property,
    "regexp": p.orange,
    "string": s.string,
    "struct": s.type,
    ...
    "function.defaultLibrary": p.cyan,
    "method.defaultLibrary": p.cyan,
    "class.defaultLibrary": s.type,
    "type.defaultLibrary": s.type,
    "namespace.defaultLibrary": s.type,
